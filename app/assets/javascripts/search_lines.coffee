$(document).ready ->
  ...
  $("#btn-search").click ->
    ...
    success: (data, textStatus, jqXHR) ->
              list_lines.html('');
              if data == null
                list_lines.append("<b>Não há resultados para sua pesquisa. Pesquise por um termo/linha diferente</b>");
                list_lines.slideDown('slow');
                return;
              ...
              if data.length == 0
                ...
                for line in data
                  list_lines.append("<p><strong> Linha "+ line['Letreiro'] +
                   "</strong> <br/>" + line['DenominacaoTPTS'] + ", " +
                   line['DenominacaoTSTP'] + ", Sentido: " + line['Sentido'] + "</p>");
